...
export default function Ingreso() {
 ...
 <Link className="p-2 bg-rich_black-600 transition-all hover:bg-rich_black-700 *:hover:fill-black *:hover:w-6" href={`/dashboard/ingresos/edit/${ingreso.id}`}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4 fill-white transition-all ">
