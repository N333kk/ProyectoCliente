...
export default function Gasto() {
 ...
 <Link className="p-2 bg-rich_black-600 hover:bg-rich_black-700 transition-all *:hover:fill-black *:hover:w-6 rounded-r-lg" href={`/dashboard/gastos/edit/${gasto.id}`}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4 fill-white hover:w-6 transition-all">
